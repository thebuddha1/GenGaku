                ...
                <div class="bg-gray-200 dark:bg-gray-800 bg-opacity-25">
                    <div class="bg-gray-200 dark:bg-gray-800 bg-opacity-25 grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 p-6 lg:p-8">
                        ...
                        <p class="mb-8 text-gray-800 dark:text-gray-200">
                            This is the main course of this sit where you'll be learning the whole of the japanese language <br>
                            ...
                            Each lesson requires you to complete 10 tests. Above the first chapter you will see your progress of which chapter and lesson you are at and how many tests you have finished. <br>
                            Down bellow you can set which writing system you want the words and sentences of the main course to be written in. <br>
                            (Don't worry if this doesn't say much yet, this will be amongst the first things you learn in chapter 1.)<br>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 p-6 lg:p-8 dark:from-gray-700/50 dark:via-transparent border-b border-gray-200 dark:border-gray-700">
                        ...
                        <p class="mb-8 text-gray-800 dark:text-gray-200">Finished tests in current lesson: {{ auth()->user()->profileProgression->fnshd_tsts }}/10 </p>
                    </div>
                    <!--Chapter 1-->
                    <div>
                        ...
                        <div class="chapter-detail p-6 lg:p-8 dark:via-transparent border-b border-gray-200 dark:border-gray-700 hidden">
                            ...
                            <div class="content-details grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 p-6 lg:p-8 dark:via-transparent border-b border-gray-200 dark:border-gray-700 hidden">
                                <p class="mb-8 text-gray-800 dark:text-gray-200">
                                    ...
                                    <br>
                                    The second most important thing to talk about when we start learning japanese is that its has a lot of writing systems compared to any western language. Not only they have a completly different set of symbol that they write with, but they have three (although we could say its four now days). Namely these writing systems are the Kanji, Hiragana, Katakana and Romanji systems. The Kanji system is the main writing system of the language. It consists of over 60 thousand characters from which only about 6-7 thousand is still used in the modern language and around 2 thousand is used by the average japanes person in everyday language. Kanji are used to describe words, parts of words or even phrases. One kanji can have different meanings attached to them and our words can be described with different kanji as well. Since we have two complete separet courses for the hiragana and katakana systems I wont go into too much details about them. In short both systems are kana systems, meaning they consists of sybols represnting syllables. Traditionaly, when writing in Japanes, sentences use characters from both the Kanji an the kana systems. Hiragana usually complete kanji that are incomplete in themselves, act as particles and represent verbs that doesnt really mean anything in themselves(later about this in the lessons). <br>
                                    <br>
                                    Lastly about the Romanji system. There isn't much to talk about here really. Romanji is basicly the japanese name of our writing system. What you read now is basicly written in romanji. Alongside the traditional ways, romanji is seeing more and more use in japanese writing as the globalisation keeps showing its effects. As a side note, in your profiles page you can chose weather you want the words in the lessons to be written in kanji, hiragana or romanji. By default, the words will be written in kanji, but if you are having difficulties with understanding the words in the tests, we recommend you to switch to the romanji option. <br>
                                    <br>
                        ...
                        <div class="chapter-detail p-6 lg:p-8 dark:via-transparent border-b border-gray-200 dark:border-gray-700 hidden">
                            ...
                            <div class="content-details grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 p-6 lg:p-8 dark:via-transparent border-b border-gray-200 dark:border-gray-700 hidden">
                                <p class="mb-8 text-gray-800 dark:text-gray-200">
                                    ...
                                    <br>
                                    One more thing about the pronouns before we move on to the next topic. You probably noticed that we havent listed out any prular pronouns. That's becaouse in japanese there is only one prular pronoun, that being 'they -> karera'. Other than this one, all the prular pronouns are formed using the 'tachi' word with a sinple pronoun and that will make up the prular counter part of the given pronoun. 'tachi' in it self doesn't really mean anything, but it's used as sort of a multiplier word. It can be used with words other than pronouns such as names or groups. Saying 'watashitachi' mean 'us', saying 'Naomitachi' means 'Naomi and the people around/with her', saying 'hitotachi' means 'people' (as we know 'hito' means person). As for our last topic for this lesson, it's a short one, let's talk about names. Names in Japanese are written in oposite order as to how they are in english. In Japanese, the surname comes first and the forename second. <br>
                                    </p>
                                <p class="mb-8 text-gray-800 dark:text-gray-200">
                                    Vocabulary for the lesson: <br>
                                    <br>
