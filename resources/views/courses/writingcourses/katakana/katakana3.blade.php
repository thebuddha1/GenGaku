...
<body>
    <div>
        <div style="margin-bottom: 10px;">
            <label for="katakanaInput" class="text-white" style="color: white !important; font-size: 1.5rem; margin-bottom: 50px;">What sound does this make:</label>
        </div>
        <div style="margin-bottom: 10px;">
            <label lass="text-white" style="color: white !important; font-size: 2rem; margin-bottom: 50px;">{{ $labelContent }}</label>
        </div>
        <div style="margin-bottom: 10px;">
            <label class="invisible" id="soundLabel" style="font-size: 20px;">{{ $soundLabelContent }}</label>
        </div>
        <div style="margin-bottom: 10px;">
            <input type="text" id="katakanaInput" name="katakanaInput" style="width: 400px; padding: 10px; border-radius: 5px; text-align: center;">
        </div>
    </div>
    ...
    <script>
        ...
        checkButton.addEventListener('click', function () {
            ...
            if (textBoxValue === soundLabelText) {
                ...
                feedbackDiv.textContent = 'Incrorrect! The right answer is ' + soundLabelText;
